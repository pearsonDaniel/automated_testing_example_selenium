...
def test_create_mipr(config_browser):
    ...
    # mipr_modal.verify_rms_id(rms_id)
    ...
    # mipr_modal.verify_dropdown_input(primary_cor, MiprModalLocators.PRIMARYCOR)
    ...
    # mipr_modal.verify_dropdown_input(service_branch, MiprModalLocators.SERVICEBRANCH)
    determination = mipr_modal.input_determination()
    # mipr_modal.verify_dropdown_input(determination, MiprModalLocators.DETERMINATION)
